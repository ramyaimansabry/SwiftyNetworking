...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftyNetworking.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/ramysabry22/SwiftyNetworking.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'SwiftyNetworking/Classes/**/*'
